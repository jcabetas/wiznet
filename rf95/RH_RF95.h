// https://raw.githubusercontent.com/PaulStoffregen/RadioHead/master/RH_RF95.h
// RH_RF95.h
//
...
// jcf
#define SPI_BUFFERS_SIZE  RH_RF95_FIFO_SIZE
...
public:
    ...
    void           setModemRegisters(ModemConfigChoice index); //const ModemConfig* config);
    ...
    /// Should not need to be called by user code, pero por el momento lo sacamos a proceso normal
    bool handleInterrupt();
    bool waitPacketSent(uint16_t timeout);  // lo hacemos publico
